...
import static com.spotify.oauth2.utility.UtilityConstants.ICON_BUG;
import static com.spotify.oauth2.utility.UtilityConstants.ICON_SMILEY_PASS;
import static com.spotify.oauth2.utility.UtilityConstants.ICON_SMILEY_FAIL;
...
import com.spotify.oauth2.utility.EmailSendUtils;
import com.spotify.oauth2.utility.ZipUtils;
...
public class ListenerClass implements ITestListener, ISuiteListener {
	...
	public void onTestStart(ITestResult result) {
		...
		ExtentReport.addAuthors(result.getMethod().getConstructorOrMethod().getMethod()
				.getAnnotation(BaseAnnotation.class).author());

		ExtentReport.addCategories(result.getMethod().getConstructorOrMethod().getMethod()
				.getAnnotation(BaseAnnotation.class).category());
